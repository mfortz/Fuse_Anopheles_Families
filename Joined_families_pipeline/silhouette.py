...
Usage: 
    $ python silhouette.py <module> [args]
...
if mode == 'all_families':
    ...
    # load gene structure
    all_gene_file = open(sys.argv[3],'r').readlines()
    ...
    pairsFile = open(sys.argv[5],'r').readlines()
        
    #output all family silhouette 
    joinedOut = open(sys.argv[6],'w')
    ...
    weightsOut = open(sys.argv[4],'w')
    
    #output all family silhouette 
    silhouetteOut = open(sys.argv[5],'w')
    
    #output joined family silhouette
    joinedOut = open(sys.argv[6],'w')
    
    insideShuffled = sys.argv[7]
